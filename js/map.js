...
function AppViewModel() {
    ...
    this.populateInfoWindow = function(marker, infowindow) {
        if (infowindow.marker != marker) {
            ...
            clientID = "MXRB5P2DV25GQWPLBADIL2I1BMPES12OVU1MVGXWS24FF5WP";
            clientSecret =
                "G5U2YX0GS3PRQKI211HEVB5R1M2GU54I04JTG2NJSQOTR4O3";
    ...
    this.initMap = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng(16.973391,82.2349693),
            zoom: 15,
            styles: styles
        };
